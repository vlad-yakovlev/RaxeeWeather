...
public class WeatherAPI {
    ...
    public static void getCurrentWeather(String city, OnCallbackListener onCallbackListener) {
    ...
    public static void getForecastWeather(String city, OnCallbackListener onCallbackListener) {
